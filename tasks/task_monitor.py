...
from modbus.modbus_addresses import in_region_cold, in_region_rewarm, in_region_wait, in_region_scan, in_region_fetch
...
with db_instance.get_session() as db_session:
    for code, station_id, status in db_session.query(Solder.SolderCode, Solder.StationID, Solder.Status).all():
